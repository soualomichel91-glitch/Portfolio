            ...
            <div className="flex flex-col items-center px-8">
              {localPersonalInfo.profilePhoto ? (
                <div className="relative group">
                  <div className="w-32 h-32 bg-white rounded-lg p-6">
                    <img
                ...
                <label className="cursor-pointer group">
                  <div className="w-32 h-32 bg-white rounded-lg p-6 flex items-center justify-center border-2 border-gray-300 hover:border-orange transition-all duration-200">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative w-64 h-36 bg-gray-100 rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="absolute left-0 top-0 w-20 h-full bg-black flex flex-col items-center py-2 px-1">
                {/* Photo avec espaces */}
                <div className="w-12 h-12 bg-white rounded p-3 mb-2">
                  {localPersonalInfo.profilePhoto ? (
                    <img
                      src={localPersonalInfo.profilePhoto}
                      alt="Photo"
